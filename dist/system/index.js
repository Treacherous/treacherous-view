System.register(["./exposer", "./helpers/class-helper", "./helpers/element-helper", "./helpers/js-literal-helper", "./states/validation-state", "./registries/view-strategy-registry", "./registries/view-summary-registry", "./view-summary-strategies/default-summary-strategy", "./view-summary-strategies/summary-handler", "./view-strategies/inline-handler", "./view-strategies/inline-strategy"], function (exports_1, context_1) {
    "use strict";
    ...
    return {
        setters: [
            ...
            function (view_summary_registry_1_1) {
                exportStar_1(view_summary_registry_1_1);
            },
            function (default_summary_strategy_1_1) {
                exportStar_1(default_summary_strategy_1_1);
            },
