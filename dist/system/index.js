System.register(["./exposer", "./helpers/class-helper", "./helpers/element-helper", "./helpers/js-literal-helper", "./registries/view-strategy-registry", "./view-strategies/inline-handler", "./view-strategies/inline-strategy", "./view-strategies/summary-handler", "./view-strategies/summary-strategy", "./states/validation-state"], function(exports_1, context_1) {
    "use strict";
    ...
    return {
        setters:[
            ...
            function (summary_strategy_1_1) {
                exportStar_1(summary_strategy_1_1);
            },
